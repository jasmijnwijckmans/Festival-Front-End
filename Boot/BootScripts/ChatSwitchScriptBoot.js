        ...
        .then(function (returndata) {
            ...
            if (returndata.success) {
                ...
                if (localStorage.getItem("UserRole") == "admin") { // when userID is admin, show this table.
                    ...
                    row += "<div>" + "Create Stage" + "<br><button class='btn' onclick='GoToCreateStage()'>Create</button></div>"
                    row += "<div>" + "ManageUsers" + "<br><button class='btn' onclick='GoToManageUsers()'>Manage users</button></div>"
                    row += "</div>"
                    row += "</div>"
                }
